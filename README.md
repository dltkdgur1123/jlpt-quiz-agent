...
✅ `50문항 실전형 문제 풀이`  
문자·어휘, 문법, 독해 영역의 50문항을 한 화면에서 풀 수 있습니다. 문제는 공식 기출문제가 아니라, 운영 중인 JLPT 학습 데이터 자동화 흐름을 바탕으로 AI가 생성하고 내부 품질 리포트로 검수한 자체 제작 문항입니다. 답변 상태를 문제 목록에서 확인하고 원하는 문항으로 이동할 수 있습니다.
...
✅ `내부 콘텐츠 품질 리포트`  
생성된 모의고사 JSON 데이터를 검사해 레벨별 세트 수, 문제 수, 영역별 구성, question type 분포, 오류/경고 여부를 내부 운영 리포트로 확인합니다.
