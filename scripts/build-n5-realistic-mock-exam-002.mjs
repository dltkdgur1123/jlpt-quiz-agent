...
const grammar = [
  ...
  q("grammar", 2, 31, "grammar_sentence_build", "sentence_build_1", "わたしは ＿ ＿ ★ ＿ 行きます。", { A: "友だち", B: "と", C: "学校へ", D: "毎朝" }, "B", "正しい順序は「毎朝 友だち と 学校へ」です。★の位置に入るのは「と」です。"),
  q("grammar", 2, 32, "grammar_sentence_build", "sentence_build_2", "この ＿ ＿ ★ ＿ おいしいです。", { A: "店", B: "の", C: "ケーキは", D: "とても" }, "C", "正しい順序は「店 の ケーキは とても」です。★の位置に入るのは「ケーキは」です。"),
