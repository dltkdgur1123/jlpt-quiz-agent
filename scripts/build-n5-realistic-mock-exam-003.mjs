...
const grammar = [
  ...
  q("grammar", 2, 31, "grammar_sentence_build", "sentence_build_1", "きのう ＿ ＿ ★ ＿ 買いました。", { A: "駅の", B: "前で", C: "花を", D: "母に" }, "D", "正しい順序は「駅の 前で 母に 花を」です。★の位置に入るのは「母に」です。"),
  ...
  q("grammar", 2, 35, "grammar_sentence_build", "sentence_build_5", "母は ＿ ＿ ★ ＿ 作っています。", { A: "台所で", B: "晩ごはんを", C: "今", D: "一人で" }, "D", "正しい順序は「今 台所で 一人で 晩ごはんを」です。★の位置に入るのは「一人で」です。"),
