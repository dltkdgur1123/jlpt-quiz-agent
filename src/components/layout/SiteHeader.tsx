    ...
    <>
      <header className={`home-topbar site-header${isScrolled ? " is-scrolled" : ""}`}>
        ...
        <nav aria-label="메인 메뉴" className="home-nav">
          ...
          <Link className={active === "mock" ? "active" : undefined} href="/mock-exams/n5">모의고사</Link>
      ...
      <nav aria-label="모바일 하단 메뉴" className="mobile-bottom-nav">
        ...
        <Link className="mobile-bottom-nav-item" data-active={active === "mock"} href="/mock-exams/n5">모의고사</Link>
