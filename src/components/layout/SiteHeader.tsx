...
type SiteHeaderProps = {
  active?: "home" | "mock" | "history" | "dashboard";
};
  ...
  return (
    <header className="home-topbar site-header">
      ...
      <nav aria-label="메인 메뉴" className="home-nav">
        ...
        <Link className={active === "history" ? "active" : undefined} href="/dashboard#history">학습 기록</Link>
        <Link className={active === "dashboard" ? "active" : undefined} href="/dashboard">대시보드</Link>
      </nav>
      <AuthHeaderButton />
    </header>
  );
