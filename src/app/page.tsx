      ...
      <div className="page-stack">
        <section className="hero-copy home-hero">
          ...
          <div className="home-cta-grid">
            <Link className="primary-link" href="/mock-exams/n5-realistic-001">N5 실전형 모의고사 001 시작</Link>
            <Link className="secondary-link" href="/mock-exams/n5-lite-002">N5 모의고사 Lite 002 보기</Link>
          </div>
        </section>
        <AuthPanel />
        <QuizMvp />
