...
function loadPreviewQuestions(): PreviewQuestion[] {
  const filePath = join(process.cwd(), "data/generated/n5-jlpt-style-preview-batch-002.json");
...
export default function N5PreviewBatch002ReviewPage() {
    ...
    <main>
      <div className="page-stack review-page-stack">
        <section className="hero-copy">
          <p className="section-eyebrow">Human Review Loop · Batch 002</p>
          <h1>N5 JLPT형 preview batch-002 문항 검수</h1>
          <p>
            쇼츠 영상 제작 검수 단계를 통과해 실제 영상 source로 반영된 최종 데이터에서 만든 draft 문항입니다.
          </p>
          <p>
